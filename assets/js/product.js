document.addEventListener('DOMContentLoaded', () => {
  ...
  root.innerHTML = `
    ...
    <div class="product-detail__info">
      ...
      <div class="product-card__meta"><span class="rating">★ ${p.rating} · ${p.reviews.toLocaleString()} ratings</span><span>${p.delivery}</span></div>
      ...
      <div style="display:flex; gap:10px; margin-top:12px">
        ...
        <a class="btn btn--primary" href="checkout.html" onclick="addToCart('${p.id}', 1)">Buy Now</a>
